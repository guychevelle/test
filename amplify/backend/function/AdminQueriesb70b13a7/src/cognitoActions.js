...
/*
 *  Custom functions added to the generated cognitoActions.js code
*/
...
async function createGroup(groupname) {
  ...
  try {
    ...
    return {
      message: `Success creating group ${groupname}`
    };
  } catch (err) {
    console.log(err);
    throw err;
...
/*
 * End of custom functions. All functions below were generated by
   Admin Studio
*/
